...
#undef __FLT_MIN__
#undef __FLT_RADIX__
#undef __FPCLASS_NEGINF
#undef __FPCLASS_NEGNORMAL
#undef __FPCLASS_NEGSUBNORMAL
#undef __FPCLASS_NEGZERO
#undef __FPCLASS_POSINF
#undef __FPCLASS_POSNORMAL
#undef __FPCLASS_POSSUBNORMAL
#undef __FPCLASS_POSZERO
#undef __FPCLASS_QNAN
#undef __FPCLASS_SNAN
#undef __FXSR__
...
#undef __GLIBCXX_BITSIZE_INT_N_0
...
#undef __LP64__
#undef __MEMORY_SCOPE_DEVICE
#undef __MEMORY_SCOPE_SINGLE
#undef __MEMORY_SCOPE_SYSTEM
#undef __MEMORY_SCOPE_WRKGRP
#undef __MEMORY_SCOPE_WVFRNT
#undef __MMX__
#undef __NO_INLINE__
...
#undef __cpp_lambdas
#undef __cpp_named_character_escapes
...
#undef __cpp_nsdmi
#undef __cpp_placeholder_variables
...
#undef __cpp_static_call_operator
#undef __cpp_structured_bindings
#undef __cpp_template_auto
